...
public class CueFlexLexerTest extends LexerTestCase {
    private final String filePath;

    public CueFlexLexerTest(@NotNull String filePath) {
    ...
    private static @NotNull Path rootPath() {
        return CueTests.findTestDataPath("lang", "cue", "lexer");
    }
}